...
public class WallpaperChooserActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,
        OnClickListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        binding.fabApplyClose.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected void cropImageAndSetWallpaper(int resId) {
        ...
        Runnable onEndCrop = new Runnable() {
            public void run() {
                ...
                WallpaperChooserActivity.this.updateWallpaperDimensions(point.x, point.y);
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        ImageAdapter(WallpaperChooserActivity context) {
